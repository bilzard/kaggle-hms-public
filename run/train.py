...
def save_sample_spec(
    ...
    if eegs is not None:
        ...
        eegs = rearrange(
            eegs,
            "(d b) (c ch) t -> b ch t (d c)",
            d=cfg.architecture.model.eeg_encoder.duality,
            c=in_channels,
        )
...
def main(cfg: MainConfig):
    ...
    eeg_dir = Path(working_dir / cfg.preprocess.name / cfg.phase / "eeg")
    spec_dir = Path(working_dir / cfg.preprocess.name / cfg.phase / "spectrogram")
